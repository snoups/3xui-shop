...
async def show_subscription(
    ...
    await callback.message.edit_text(
        text, reply_markup=subscription_keyboard(client_service, callback_data)
...
async def callback_subscription(callback: CallbackQuery, vpn_service: VPNService) -> None:
    ...
    callback_data = SubscriptionCallback(state=Navigation.PROCESS)
...
async def callback_subscription_process(
    ...
    await callback.message.edit_text(
        text, reply_markup=traffic_keyboard(plans_service, callback_data)
    )
