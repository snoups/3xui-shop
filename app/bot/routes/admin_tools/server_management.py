...
@router.message(AddServerStates.name, IsPrivate(), IsDev())
...
@router.message(AddServerStates.host, IsPrivate(), IsDev())
...
@router.message(AddServerStates.subscription, IsPrivate(), IsDev())
...
@router.message(AddServerStates.max_clients, IsPrivate(), IsDev())
...
@router.callback_query(F.data.startswith(NavAdminTools.PING_SERVER), IsPrivate(), IsDev())
...
@router.callback_query(F.data.startswith(NavAdminTools.DELETE_SERVER), IsPrivate(), IsDev())
